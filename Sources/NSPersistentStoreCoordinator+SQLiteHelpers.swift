...
public extension NSPersistentStoreCoordinator {
    ...
    /**
     ...
     - parameter completion: A completion closure with a `CoordinatorResult` that will be 
     executed following the `NSPersistentStore` being added to the 
     `NSPersistentStoreCoordinator`. added to the `NSPersistentStoreCoordinator`.
     */
